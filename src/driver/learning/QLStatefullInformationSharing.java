...
import experiments.AditionalData;
 ...
 * @author rgrunitzki
 */
public class QLStatefullInformationSharing extends Driver<QLStatefullInformationSharing, List<Edge>> {
...
//    private String previousVertex;
    ...
    public QLStatefullInformationSharing(int id, String origin, String destination, Graph graph) {
    ...
    public void beforeSimulation() {
        ...
        if (staticMdp == null) {
            ...
            try {
                ...
                Logger.getLogger(QLStatefullInformationSharing.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
                this.mdp = (StatefullMDP) staticMdp.clone();
...
//        double r = this.rewardFunction.getStandardReward(this);
        ...
        if (!QLStatefullInformationSharing.aditionalData.containsKey(currentEdge)) {
            QLStatefullInformationSharing.aditionalData.put(currentEdge, new AditionalData());
        }

//        QLStatefull.aditionalData.get(currentEdge).addValue(qa);
        QLStatefullInformationSharing.aditionalData.get(currentEdge).addValue(travelTime);
...
//        }
    ...
    public List<Pair> getParameters() {
        ...
        list.add(Pair.of("alpha", QLStatefullInformationSharing.ALPHA));
        list.add(Pair.of("gamma", QLStatefullInformationSharing.GAMMA));
        return list;
    }
